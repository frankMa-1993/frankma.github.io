  ...
  themeConfig: {
    ...
    nav: [
      {
        ...
        items: [
          ...
          { text: "Rust", link: "/articles/rust/01.基础入门" },
    ...
    sidebar: {
      "/articles/basic": autoGetSidebarOptionBySrcDir(
        ...
        path.resolve(__dirname, "../articles/basic-bitdance"),
        "字节青训笔记"
      )),
      "/articles/vue": autoGetSidebarOptionBySrcDir(
        ...
        path.resolve(__dirname, "../articles/vue组件库"),
        "VUE组件库开发教程"
      )),
      ...
      "/articles/rust": autoGetSidebarOptionBySrcDir(
        path.resolve(__dirname, "../articles/rust"),
      ).concat(autoGetSidebarOptionBySrcDir(
        path.resolve(__dirname, "../articles/rustweb"),
      )),
